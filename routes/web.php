...
Route::get('/user/password', 'UserController@password')->name('user.password')->middleware('auth');
Route::get('/user/main', 'UserController@main')->name('user.main')->middleware(['auth', 'admin']);
Route::get('/notice_type/main', 'NoticeTypeController@main')->name('notice_type.main')->middleware('auth');
